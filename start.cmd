...
echo "2. Zapret: Discord v2 (любые провайдеры,  предпочтительно Ростелеком)"
...
echo.
echo "20. Strategy 2 (устаревшая, иногда ютуб разблокируется на Ростелекоме)"
echo "21. Strategy 3 (устаревшая)"
echo.
echo "30. Ультимейт конфиг ZL (разблокирует любые сайты, любые провайдеры)"
echo "31. Ультимейт конфиг v2 (разблокирует любые сайты, любые провайдеры)"
echo.
echo.
