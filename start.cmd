...
echo 4. Zapret: Discord v4 (УльтиМейт фикс, разблокирует любые сайты, работает на Билайн и Ростелеком)
echo.
...
echo.
echo 30. Ультимейт конфиг ZL (любые провайдеры)
echo 30. Ультимейт конфиг v2 (любые провайдеры)
echo.
echo.
