...
--filter-tcp=443 --hostlist="%~dp0russia-youtube.txt" --dpi-desync=fake,split2 --dpi-desync-fooling=md5sig --dpi-desync-split-seqovl=2 --dpi-desync-split-pos=2 --dpi-desync-fake-tls="%~dp0tls_clienthello_2.bin" --dpi-desync-ttl=5 --new ^
...
--filter-tcp=443 --hostlist="%~dp0russia-discord.txt" --dpi-desync=syndata --dpi-desync-fake-syndata="%~dp0tls_clienthello_3.bin"  --dpi-desync-ttl=5 --new ^
